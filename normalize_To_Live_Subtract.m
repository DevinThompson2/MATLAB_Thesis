function [avgData, stdeData, percentEvents] = normalize_To_Live_Subtract(signalData, eventData, indices, pitchInfo, signalName, graphName, subjectName, unit)
