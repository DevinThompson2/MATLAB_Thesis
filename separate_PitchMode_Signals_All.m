function [outRaw, outPercent, outSubtract, outRawTime] = separate_PitchMode_Signals_All(subjectData, signalName, graphName, subjectName, eventData, signalType, pitchInfo)
...
%% Don't need to do any averaging, I just want the raw data - Don't need any of the stuff below
...
%     % Normalized to Live bu subtraction
...
%     xline(normTeeEvents,'r-', 'LineWidth',2, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel)
%     xline(normBPEvents,'g-', 'LineWidth',2, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel)
%     xline(normCannonEvents,'b-', 'LineWidth',2, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel)
%     xline(normLiveEvents,'k-',events, 'LineWidth',2, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel)
%     xline(pitchInfo(1),'c-','Pitcher Foot Up (est)','LineWidth',1, 'LabelHorizontalAlignment', 'center','FontSize',xLineLabelSize,'FontWeight', boldLabel,'Color', pitchColor)
%     xline(pitchInfo(2),'c-','Pitcher Knee Up (est)','LineWidth',1, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel,'Color', pitchColor)
%     xline(pitchInfo(3),'c-','Pitcher Hand Separation (est)','LineWidth',1, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel,'Color', pitchColor)
%     xline(pitchInfo(4),'c-','Pitcher Foot Down (est)','LineWidth',1, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel,'Color', pitchColor)
%     xline(pitchInfo(5),'c-','Pitch Release (est)','LineWidth',1, 'LabelHorizontalAlignment','center','FontSize',xLineLabelSize,'FontWeight', boldLabel,'Color', pitchColor)
%     xlim([-2 0.5])
