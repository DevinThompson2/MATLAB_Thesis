function plot_Pitch_Location(tee, bp, cannon, live)
%This function generates a plot to show the ball distributions
...
title("Pitch Location For Each Method (2ft in front of plate)")
