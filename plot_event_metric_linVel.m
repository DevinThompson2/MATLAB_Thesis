function plot_event_metric_linVel(teeData, bpData, cannonData, liveData, metric)
...
% Convert everything to mph from m/s
avgMat = avgMat * 2.23694;
stdeMat = stdeMat * 2.23694;
