function [avgData, stdeData, percentEvents, normalizedData] = normalize_To_Live(signalData, eventData, indices, pitchInfo, signalName, graphName, subjectName, unit, graph)
...
if graph == 1
    ...
    ylabel(strcat(graphName, " (Percent of Live)"),'FontSize', labelSize, 'FontWeight', boldLabel)
