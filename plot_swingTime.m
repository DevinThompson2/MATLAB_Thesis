function [avgMat, stdeMat] = plot_swingTime(teeData, bpData, cannonData, liveData, metric, names)
...
maxTee = teeData.TimingData;
maxBP = bpData.TimingData;
maxCannon = cannonData.TimingData;
maxLive = liveData.TimingData;
...
xticks(1:4)
ylabel(strcat(graphName, " (s)"), 'FontWeight','bold')
